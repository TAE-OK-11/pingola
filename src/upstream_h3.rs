...
const MAX_BODY_FRAMES: usize = 16;
const H3_BODY_RECV_BUFFER: usize = 16 * 1024;
const INITIAL_MAX_DATA: u64 = 32 * 1024 * 1024;
const INITIAL_STREAM_WINDOW: u64 = 2 * 1024 * 1024;
const H3_CONTROL_STREAMS: u64 = 8;
const SEND_CAPACITY_FACTOR: f64 = 3.0;
const CC_CUBIC: &str = "cubic";
const CC_BBR2: &str = "bbr2";
const BRIDGE_H2_STREAM_WINDOW: u32 = 2 * 1024 * 1024;
const BRIDGE_H2_CONNECTION_WINDOW: u32 = 32 * 1024 * 1024;
