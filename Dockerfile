...
ARG PGO_WEIGHT_COMPRESS_BR=120
...
LABEL org.opencontainers.image.title="Pingora" \
      ...
      org.opencontainers.image.rust.pgo-weight-compress-br="${PGO_WEIGHT_COMPRESS_BR}" \
